...
const useCustomerStore = create((set, get) => ({
  ...
  fetchCustomers: async () => {
    ...
    try {
      ...
      console.error('[Customer] Failed to fetch customers:', err)
  ...
  fetchCustomerDetail: async (id) => {
    ...
    try {
      ...
      console.error('[Customer] Failed to fetch detail:', err)
