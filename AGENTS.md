...
This project is indexed by GitNexus as **hivepro-cs-control-plane** (1838 symbols, 4776 relationships, 147 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
